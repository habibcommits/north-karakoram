...
const sampleTripsData: Trip[] = [
  ...
  {
    id: "13",
    title: "K2 AND GONDOGORO LA TREK",
    description: "Trek to K2 and Gondogoro La, one of the most challenging and scenic treks in the Karakoram Range. Experience breathtaking views surrounded by 8000m peaks.",
    shortDescription: "Trek to K2 and Gondogoro La with stunning Karakoram views...",
    destination: "Gilgit Baltistan",
  ...
  },
  {
    ...
    description: "Trek to the base camp of K2, the world's second highest mountain. Experience the magnificent Karakoram landscape and reach the foot of the legendary peak.",
    shortDescription: "Trek to K2 Base Camp at the foot of the second highest peak...",
    destination: "Gilgit Baltistan",
  ...
  {
    id: "15",
    title: "FIVE 8000M BASE CAMP TREK, PAKISTAN",
    description: "Trek to the base camps of five 8000m peaks including K2, Broad Peak, and the Gasherbrums. An epic adventure through the highest mountain realm.",
    shortDescription: "Trek to base camps of five 8000m peaks in Pakistan...",
    destination: "Gilgit Baltistan",
  ...
  },
  {
    ...
    description: "Trek to the base camp of Nanga Parbat, the ninth highest mountain in the world. Marvel at this 8126m peak and its dramatic landscapes.",
    shortDescription: "Trek to Nanga Parbat Base Camp, the Killer Mountain...",
    destination: "Diamer District",
  ...
  {
    id: "17",
    title: "FAIRY MEDOW TREK",
    description: "Fairy Meadows trek offers stunning views of Nanga Parbat. Trek through lush green meadows and experience one of the most beautiful high-altitude landscapes.",
    shortDescription: "Trek through Fairy Meadows with views of Nanga Parbat...",
    destination: "Diamer District",
  ...
  },
  {
    ...
    description: "Trek around the base of Nanga Parbat for a complete circular route. Experience diverse landscapes and cultural encounters in the Diamer region.",
    shortDescription: "Circular trek around the base of Nanga Parbat...",
    destination: "Diamer District",
  ...
  },
  {
    ...
    description: "Trek through the pristine Nangma Valley, known for its dramatic granite peaks and pristine alpine meadows. A hidden gem in the Karakoram.",
    shortDescription: "Trek through pristine Nangma Valley with dramatic peaks...",
    destination: "Gilgit Baltistan",
    duration: "10 Days - 9 Nights",
    price: 1500,
    category: "Trekking",
  ...
  },
  {
    ...
    description: "Trek over the scenic Thalle La pass with breathtaking views of the Karakoram Range. Experience high-altitude mountain scenery and pristine wilderness.",
    shortDescription: "Trek over Thalle La pass with Karakoram views...",
    destination: "Gilgit Baltistan",
    duration: "11 Days - 10 Nights",
    price: 1700,
    category: "Trekking",
  ...
  {
    id: "21",
    title: "SNOW LAKE-HISPER LA TREK PAKISTAN",
    description: "Trek to Snow Lake and over Hispar La in the Karakoram. Traverse vast glaciers and experience one of Pakistan's most stunning high-altitude routes.",
    shortDescription: "Trek to Snow Lake and Hispar La through Karakoram glaciers...",
    destination: "Gilgit Baltistan",
    duration: "16 Days - 15 Nights",
    price: 2800,
    category: "Trekking",
  ...
  {
    id: "22",
    title: "PASTORE PEAK PAKISTAN",
    description: "Trek to Pastore Peak in Pakistan's stunning Karakoram Range. Enjoy moderate trekking with excellent camping sites and mountain views.",
    shortDescription: "Trek to Pastore Peak in the Karakoram Range...",
    destination: "Gilgit Baltistan",
    duration: "10 Days - 9 Nights",
    price: 1600,
    category: "Trekking",
  ...
  },
  {
    ...
    description: "Trek through the remote Shimshal Valley and over Shimshal Pass. Experience pristine wilderness and encounter nomadic communities in the high Pamir.",
    shortDescription: "Trek through Shimshal Valley over Shimshal Pass...",
    destination: "Gilgit Baltistan",
