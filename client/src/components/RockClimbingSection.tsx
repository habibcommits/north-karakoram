  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 mb-3 sm:mb-4">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-[#006F61]">Granite Spires</span>
            </span>
          </h2>
        ...
        >
          {filters.map((filter) => {
            ...
            return (
              ...
              >
                <Anchor className={`w-4 h-4 transition-all group-hover:scale-110
        ...
        >
          {[
            { value: rockClimbings.length, label: "Total Routes" },
            { value: "4.9★", label: "Avg Rating" },
            { value: "200+", label: "Climbers Guided" },
          ].map((stat, index) => (
