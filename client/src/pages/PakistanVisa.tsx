...
export default function PakistanVisa() {
  const seo = usePageSEO('pakistanVisa');

  const breadcrumbs = [
    { name: 'Home', path: '/' },
    { name: 'Pakistan Visa Guide', path: '/pakistan-visa' },
  ];
  ...
  return (
    <>
      {seo && <SEOHead seo={seo} path="/pakistan-visa" />}
      <BreadcrumbSchema items={breadcrumbs} />
      <ArticleSchema
        title="Pakistan Visa Guide - Tourist & Mountaineering Visa Requirements"
        description="Complete Pakistan visa guide including e-visa process, required documents, processing times, and NOC requirements for Gilgit-Baltistan travel."
        image={`${SITE_CONFIG.url}/images/og/visa.jpg`}
