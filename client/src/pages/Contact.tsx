...
import { BreadcrumbSchema, LocalBusinessSchema } from "@/seo/StructuredData";
...
function ContactPageSchema() {
  const schema = {
    ...
    "@type": "ContactPage",
    name: "Contact North Karakoram Trek & Tours",
    description:
      "Get in touch with North Karakoram Trek & Tours for expedition bookings, custom trip planning, and travel inquiries.",
...
export default function Contact() {
  ...
  return (
    <>
      {seo && <SEOHead seo={seo} path="/contact" />}
