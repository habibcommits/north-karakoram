...
import { rockClimbings as expeditions, getRockClimbingsBySlug } from "@/lib/rockClimbingData";
...
export default function RockClimbingDetails() {
  const { slug } = useParams<{ slug: string }>();
  const expedition = getRockClimbingsBySlug(slug || "");
  ...
  const seo = expedition
    ? generateDynamicSEO('rock-climbing', slug!, {
  ...
  const breadcrumbItems = expedition
    ? [
      { name: 'Rock Climbing', path: '/rock-climbing' },
      { name: expedition.name, path: `/rock-climbing/${slug}` },
    ]
    : [];
        ...
        <main className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            <h1 className="font-heading font-bold text-3xl md:text-4xl text-gray-900 mb-4">
              Rock Climbing Not Found
            </h1>
            <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">
              The rock climbing you're looking for doesn't exist or may have been moved.
            </p>
  ...
  return (
    <>
      {seo && <SEOHead seo={seo} path={`/rock-climbing/${slug}`} />}

      <TouristTripSchema
        name={expedition.name}
        description={expedition.description}
        image={expedition.image || SITE_CONFIG.defaultImage}
        url={`${SITE_CONFIG.url}/expedition/${slug}`}
                      ...
                      <TabsContent value="prices" className="mt-8">
                        <Card className="border-0 shadow-lg rounded-2xl overflow-hidden">
                          ...
                          >
                            ...
                            <p className="text-gray-600 mb-8 max-w-md mx-auto">
                              Every rock climbing is unique. Contact us for personalized pricing
              ...
              >
                ...
                <div className="relative z-10 text-center max-w-3xl mx-auto">
                  ...
                  <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
                    Join our expert team for an unforgettable rock climbing experience.
