...
import { trekkings as expeditions } from "@/lib/trekkingData";
...
function ExpeditionCard({ expedition }: { expedition: ExpeditionData }) {
  ...
  return (
    <Link href={`/trekking/${expedition.slug}`}>
...
export default function Trekking() {
  ...
  return (
    <>
      {seo && <SEOHead seo={seo} path="/trekking" />}
      <CollectionSchema
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
            <div className="h-full flex flex-col justify-center max-w-4xl">
              ...
              >
                ...
                <span className="tracking-wide">Iconic Treks</span>
              </div>
              ...
              >
                Professional trekking to K2, Nangma, Thalle, Fairy Meadows and more.
            ...
            <div className={`${showFilters ? 'block' : 'hidden md:block'} space-y-3`}>
              <div className="flex flex-col md:flex-row gap-3">
                ...
                <div className="relative flex-grow">
                  ...
                  <input
                    type="search"
                    placeholder="Search trekking by name or location..."
                    value={searchQuery}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 sm:mb-10 lg:mb-12">
              <div>
                ...
                <h2 className="font-bold text-2xl sm:text-3xl md:text-4xl text-gray-900">
                  {selectedPeakCategory === "6000m" && "Six-Thousander Trekking"}
                  {selectedPeakCategory === "5000m" && "Five-Thousander Trekking"}
                  {selectedPeakCategory === "4000m" && "Four-Thousander Trekking"}
                  {selectedPeakCategory === "all" && "All Peak Trekking"}
                </h2>
              </div>
              <p className="text-gray-500 text-sm sm:text-base">
                <span className="font-semibold text-gray-800">{filteredExpeditions.length}</span> {filteredExpeditions.length === 1 ? 'trekking' : 'trekking'} available
              </p>
            </div>
            ...
            {filteredExpeditions.length === 0 ? (
              <div className="text-center py-16 sm:py-20 lg:py-24">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">No trekking found</h3>
                <p className="text-gray-500 text-base sm:text-lg mb-8 max-w-md mx-auto">
                  We couldn't find any trekking matching your current filters. Try adjusting your search criteria.
                </p>
                <button
                  onClick={clearFilters}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-white/80 text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed">
                Join our expert-led trekking to the world's most challenging peaks. From K2 to Broad Peak, we'll guide you every step of the way.
              </p>
